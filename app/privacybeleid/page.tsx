...
//   Goedkoopstroom.be            e.g. Btw-calculator.be
//   goedkoopstroom.be          e.g. btw-calculator.be
//   stroomleveranciers vergelijken     e.g. BTW bedragen berekenen
...
export const metadata: Metadata = {
  ...
  description: 'Hoe Hazier persoonsgegevens verwerkt op Goedkoopstroom.be. AVG/GDPR-conform, met verwerkingsverantwoordelijke, doeleinden, cookies en uw rechten.',
  alternates: { canonical: 'https://goedkoopstroom.be/privacybeleid' },
    ...
    <main className="mx-auto max-w-3xl px-4 py-10">
      ...
      <div className="prose prose-gray mt-6 max-w-none">
        <p>
          ...
          Goedkoopstroom.be (stroomleveranciers vergelijken) bezoekt of gebruikt. Wij nemen uw privacy
        ...
        <p>
          ...
          Goedkoopstroom.be vereist geen registratie of account.
        </p>
        ...
        <p>
          Goedkoopstroom.be gebruikt Google Consent Mode v2. Wanneer u onze site voor het eerst
        ...
        <ul>
          ...
          <li><strong>Hostingprovider</strong> — voor opslag en serving van goedkoopstroom.be.</li>
        </ul>
        ...
        <p>
          ...
          <code>https://goedkoopstroom.be/privacybeleid</code>. Bij substantiële wijzigingen
