    ...
    <footer className="mt-10 pb-10 text-center text-gray-500">
      <div className="max-w-4xl mx-auto px-4">
        <div className="flex flex-wrap items-center justify-center gap-x-5 gap-y-2 text-sm mb-3">
          <Link href="/" className="text-orange-700 hover:text-orange-900 underline">Home</Link>
          <Link href="/over-mij" className="text-orange-700 hover:text-orange-900 underline">Over de maker</Link>
          <a href="mailto:info@hazier.be" className="text-orange-700 hover:text-orange-900 underline">Contact</a>
        </div>
